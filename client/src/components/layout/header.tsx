          ...
          <div className="flex justify-between items-center h-18">
                  ...
                  {navItems.map((item) => (
                    <li key={item.href}>
                      <Link href={item.href} aria-label={`Go to ${item.label} page`} tabIndex={0}>
                        <div
                          className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-blue-400 ${
                            isActive(item.href)
            ...
            <div className="flex items-center">
              <div className="hidden md:block">
                <Button asChild className="gradient-primary text-white hover:shadow-lg transition-all duration-200 px-6 focus:outline-none focus:ring-2 focus:ring-blue-400">
